export const messages = {
  en: {
    ...
    description: 'Polaris 1.0.0 connects AI coding tools to 23 providers through one self-hosted gateway. Polaris handles routing, protocol translation and automatic fallback.',
  ...
  vi: {
    ...
    description: 'Polaris 1.0.0 kết nối các công cụ lập trình AI với 23 nhà cung cấp qua một gateway tự triển khai. Polaris lo định tuyến, chuyển đổi giao thức và tự động dự phòng.',
